...
class SearchDeserializerTest extends TestCase
{
    ...
    public function testCanExtractMultipleResults()
    {
        ...
        $this->assertEquals( 2, count( $results ), "results variable should contains exatly two objects" );
    }
    ...
    public function testCanExtractMovieId()
    {
        ...
        $this->assertEquals( 'rampage-291177', $result->getID(), "MafabMovie ID does not match!" );
    }
    ...
    public function testCanExtractMovieHungarianTitle()
    {
        ...
        $this->assertEquals( 'Rampage: Tombolás', $result->getHungarianTitle(), "MafabMovie HungarianTitle does not match!" );
    }
    ...
    public function testCanExtractMovieOriginalTitle()
    {
        ...
        $this->assertEquals( 'Rampage',           $result->getOriginalTitle(),  "MafabMovie OriginalTitle does not match!" );
    }
    ...
    public function testCanExtractMovieUrl()
    {
        ...
        $this->assertEquals( 'https://www.mafab.hu/movies/rampage-291177.html', $result->getURL(), "MafabMovie URL does not match!" );
    }
    ...
    public function testCanExtractMovieYear()
    {
        ...
        $this->assertEquals( 2018, $result->getYear(), "MafabMovie Year does not match!" );
    }
    ...
    public function testCanExtractMovieThumbnalImage()
    {
        ...
        $this->assertEquals( 'https://mafab.hu/static/thumb/w60/2018/92/02/291177_1522714089.6506.jpg', $result->getThumbnailImage(), "MafabMovie ThumbnailImage does not match!" );
    }
}